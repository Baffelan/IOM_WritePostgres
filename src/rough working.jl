...
onboarded = process_articles(999, [today()-Day(3),today()-Day(2)], false, JSON.parse(ENV["IOMALIGNMENTTOKENS"]),Date.(JSON.parse(ENV["IOMBURNINRANGE"])), parse(Int,ENV["IOMEMBDIM"]))
