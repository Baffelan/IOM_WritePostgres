"""
Calculates a Singular Value Decomposition for the matrix 'A' to a dimension 'd'.
Inspired by https://github.com/MxAR/FameSVD.jl

# Arguments
- 'A::Array{R, 2}': Matrix to find SVD of.
